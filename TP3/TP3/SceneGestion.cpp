...
bool SceneGestion::init(RenderWindow * const window)
{
	...
	for (int i = 0; i< NBBUTTONS; ++i)
	{
		...
		if (i == 0)
			buttons[i].insererTexte("Creer un compte");
		else if (i == 1)
			buttons[i].insererTexte("Modifier un compte");
		else if (i == 2)
			buttons[i].insererTexte("Effacer un compte");
		else if (i == 3)
